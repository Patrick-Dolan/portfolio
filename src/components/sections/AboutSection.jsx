    ...
    <section id="about" className="py-24">
      <SectionContainer>
        <div className="lg:grid lg:grid-cols-2 lg:justify-between lg:items-center lg:gap-10">
          ...
          <div className="border border-secondary-light rounded-3xl px-4 py-8 text-center lg:h-full lg:flex lg:flex-col lg:justify-center lg:p-10">
            <h2 className="text-3xl mb-2 font-bold uppercase">About Me</h2>
            <p className="mb-6 lg:mb-10">A Little Bit About Myself</p>
