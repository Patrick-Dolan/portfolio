...
function AboutSection() {
  return (
    <section id="about" className="py-24">
      <SectionContainer>
        <img src="/assets/sillypic.jpg" alt="Patrick in a duck costume with hands on hips." className="mx-auto mb-10 rounded-3xl  shadow-xl max-w-80 md:max-w-96" />
        <div className="border border-secondary-light rounded-xl px-4 py-8">
          ...
          <p className="text-center text-sm mb-8">A Little Bit About Myself</p>
