  ...
  return (
    <article className="flex items-center justify-center text-center">
      <div>
        ...
        <p className="text-sm mt-4 mb-6">I build websites with a mix of code and calculations. When I&apos;m not writing code, I&apos;m usually getting lost in a good book.</p>
